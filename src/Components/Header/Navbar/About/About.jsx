...
const About = () => {
    ...
    return (
        <div className="-z-1 " >
            ...
            <div style={{ zIndex: -1 }}>
                <section className="bg-neutral-600 text-white -z-50 ">
                    <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl ">

                        {/* Title section */}
                        <div className="-z-600 lg:animate__lightSpeedInRight lg:animate__animated lg:animate__slow">
                            <h2 className="text-3xl  font-bold tracking-tight text-center sm:text-5xl dark:text-gray-900 -z-1">Real Estate Website Features and Characteristics</h2>
                            <p className="max-w-3xl mx-auto mt-4 text-xl text-center font-medium ">The User Interface menualy work Assistent</p>
                        </div>

                        {/* first body */}
                        <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center animate__zoomIn animate__animated animate__slow">
                            <div>
                ...
                <section className="bg-neutral-600 text-white -z-50">
                    <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                        <div className="animate__lightSpeedInRight animate__animated animate__slow">
                ...
                <section data-aos="zoom-in" data-aos-duration="1500" className="m-4 md:m-8 rounded-md dark:bg-gray-100 dark:text-gray-800">
