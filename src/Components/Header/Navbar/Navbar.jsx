    ...
    return (
        <div>
            <div data-aos="fade-down" data-aos-duration="1500" className="">
                <div className="navbar bg-neutral-600 animate__zoomIn animate__animated animate__slow">
                    <div className="navbar-start z-50">
                        <div className="dropdown ">
                            <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden  ">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                            </div>
                            <ul tabIndex={0} className="menu menu-sm dropdown-content  mt-3 text-white z-50 p-1 shadow bg-green-700 rounded-box w-52  ">
                                {links}
                            </ul>
                        </div >
