...
const Blog = () => {
    ...
    return (
        <div style={{ zIndex: -1 }} className="mt-4 -z-10">

            <section className="py-6 sm:py-12  bg-neutral-600 text-black">
                <div className="container p-6 mx-auto space-y-8">
                    ...
                    <section className="">
                        <div className="grid grid-cols-1  gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4 animate__zoomIn animate__animated animate__slow lg:mt-0 ">

                            <article className="flex rounded-md flex-col dark:bg-gray-50 mt-8 lg:mt-0">
            ...
            <section className="bg-neutral-600 dark:text-gray-800 animate__zoomIn animate__animated animate__slow">
                <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                    <a data-aos="flip-down" rel="noopener noreferrer" href="#" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-50">
                    ...
                    <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        <a data-aos="flip-left"
                            ...
                            data-aos-duration="2000" rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
                        ...
                        <a data-aos="flip-left"
                            data-aos-easing="ease-out-cubic"
                            data-aos-duration="2000" rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50 hidden sm:block">
                    ...
                    <div className="flex justify-center animate__backInLeft animate__animated animate__slow">
