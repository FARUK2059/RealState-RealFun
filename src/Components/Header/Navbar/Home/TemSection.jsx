...
const TemSection = () => {
    return (
        ...
        <div data-aos="zoom-in" data-aos-duration="1500" className="lg:p-4 md:p-4 p-2 ">
            <section className="py-6 bg-neutral-400 rounded-md text-white">
                <div className="container flex flex-col   items-center justify-center p-4 mx-autospace-y-8 sm:p-10">
                    <h1 className="text-4xl font-bold leading-none text-center sm:text-5xl">Our team</h1>
                    <p className="max-w-2xl text-center text-yellow-200">At a assumenda quas cum earum ut itaque commodi saepe rem aspernatur quam natus quis nihil quod, hic explicabo doloribus magnam neque, exercitationem eius sunt!</p>
                    <div className="flex flex-row flex-wrap-reverse justify-center">

                        <div data-aos="flip-up" data-aos-duration="1500" className="flex flex-col justify-center m-8 text-center">
