...
const SeenSection = () => {
    return (
        ...
        <div data-aos="fade-up" data-aos-duration="1500" className="lg:p-4 md:p-4 p-2 ">
            <section className="py-6 bg-zinc-400 rounded-md dark:text-gray-800">
                <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
                    ...
                    <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
                        ...
                        <div data-aos="flip-left"
                            ...
                            data-aos-duration="2000" className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100">
